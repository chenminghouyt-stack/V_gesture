...
# 1. 頁面基本配置
st.set_page_config(page_title="學生侯承明專題：勝利手勢偵測", layout="wide")

# --- 側邊欄 (Sidebar) ---
st.sidebar.header("📁 學生侯承明基本資料")
school = st.sidebar.text_input("高中名稱", "台南大學附屬高級中學")
name = st.sidebar.text_input("學生姓名", "侯承明")
interest = st.sidebar.text_area("興趣", "解數學題")
